...
},{"./modules/form-validate/form":3,"./modules/hero-slider":9,"./modules/modals/init-modals":10,"./modules/video":12,"./utils/ios-vh-fix":15}],2:[function(require,module,exports){
"use strict";
...
var initHeroSlider = exports.initHeroSlider = function initHeroSlider() {
  var heroSlider = document.querySelector('[data-swiper="hero"]');
  var heroPagination = document.querySelector('[data-swiper="pagination"]');
  var mySwiper = new window.Swiper(heroSlider, {
    loop: true,
    pagination: {
      el: heroPagination,
      type: 'bullets',
